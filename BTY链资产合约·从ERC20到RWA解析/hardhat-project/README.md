...
本项目已实现完整的RWA（真实世界资产）管理系统，包括：

- **RWA3643Token**：基于ERC3643标准的合规代币
- **AssetRegistry**：设备登记和管理
- **RevenueDistributor**：收益分配机制

详细使用说明请查看：[RWA-README.md](./RWA-README.md)
